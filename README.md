...
- **Scale & Zoom Control**: Dilengkapi kontrol zoom (50%, 75%, 100%, 125%) untuk memastikan tata letak responsif dapat dipantau dengan jelas di berbagai resolusi layar monitor.
- **Realistic Device Frame**: Bingkai preview perangkat yang bersih dengan scrollbar terisolasi dan indikator dimensi piksel aktif.
...
- **Mode Target Fleksibel**:
  ...
  - **Teks Tulisan (`text-clip`)**: Menerapkan gradien memukau langsung pada huruf/tipografi menggunakan `-webkit-background-clip: text` dan `-webkit-text-fill-color: transparent` tanpa kotak latar tertutup atau pemotongan teks yang rusak.
...
- Berkas HTML asli Anda tidak akan terhapus atau rusak karena aplikasi hanya menyematkan referensi stylesheet secara aman.
